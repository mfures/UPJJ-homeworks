...
public class LinkedListIndexedCollection<T> implements List<T> {
	 ...
	 *
	 */
	private static class LinkedListElementsGetter<K> implements ElementsGetter<K> {
		/**
		 ...
		 */
		private LinkedListIndexedCollection<K> collection;
		 ...
		 */
		private LinkedListElementsGetter(LinkedListIndexedCollection<K> collection) {
	...
	public void insert(T value, int position) {
		...
		if (size == position) {
			last.nextNode = new ListNode<T>(value);
			updateLastNode(last.nextNode);
			return;
		}

		ListNode<T> newNode = new ListNode<T>(value);
		ListNode<T> tmpNode = getNodeAt(position);
	 ...
	 */
	private void updateLastNode(ListNode<T> node) {
