...
public class Utility {
	 ...
	 * Key for shared data
	 */
	public static final String SHARED_DATA_KEY = "cdstack";
	...
	/**
	 * Returns path if given string is URL to directory, otherwise throws an
	 * exception
	 * 
	 * @return path to directory
	 * @throws IllegalArgumentException if input is invalid
	 */
	public static Path getPathIfDirectory(String input) {
		Path path;

		try {
			path = Utility.toPath(input);
		} catch (Exception e) {
			throw new IllegalArgumentException("Couldn't access given path.");
		}
	 ...
	 * @throws IllegalArgumentException if input is invalid
	 */
	public static Path getPathIfNotDirectory(String input) {
		Path path;
